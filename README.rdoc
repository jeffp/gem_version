...
Never mess with updating the version for your next gem build.  Configured in your Rakefile, gem_version automatically provides the next version and commits it to the repository.
